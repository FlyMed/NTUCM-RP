...
/*----------------------------------------------------*/
	...
	$accor.each(function() {
		...
		$(this).find("div").hide().first();
		// Remove Following for Default Close All - by Clementtang
...
/*----------------------------------------------------*/
/*	Tooltip (Updated for Bootstrap 3.1.0 by Clement Tang 20140214)
/*----------------------------------------------------*/
...
/*----------------------------------------------------*/
/*	Popover (Added by Clement Tang 20140214)
/*----------------------------------------------------*/
...
/* Adding List Style Filter by Clement Tang 20130804
----------------------------------------------------*/
	$(window).load(function(){
		$('#portfolio-wrapper').isotope({
			  itemSelector : '.isotope-item',
		...
		$('#filters-list a.selected').trigger("click");
	});
